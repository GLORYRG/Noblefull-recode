...
import cn.noblefull.event.impl.events.player.PostStrafeEvent;
import cn.noblefull.event.impl.events.player.StrafeEvent;
import cn.noblefull.module.impl.visuals.FreeLook;
...
//            ChatUtil.display(Math.hypot((double) (strafe * f2 - forward * f1), (double) (forward * f2 + strafe * f1)));
    ...
    /**
     * Adds a value to the player score. Currently not actually used and the entity passed in does noblefull. Args:
     * entity, scoreToAdd
     */
