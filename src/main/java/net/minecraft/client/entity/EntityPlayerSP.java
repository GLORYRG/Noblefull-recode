...
import cn.noblefull.module.impl.movement.GuiMove;
...
import cn.noblefull.event.impl.events.misc.ChatEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isSprinting() && (!this.omniSprint && (this.movementInput.moveForward < f || this.isCollidedHorizontally || !flag3 || GuiMove.shouldStopSprint)))
        {
            this.setSprinting(false);
        }
