...
import cn.noblefull.event.impl.events.misc.KeyPressEvent;
import cn.noblefull.event.impl.events.misc.TickEvent;
import cn.noblefull.event.impl.events.misc.WorldLoadEvent;
import cn.noblefull.event.impl.events.player.PlaceEvent;
import cn.noblefull.event.impl.events.player.RightClickerEvent;
import cn.noblefull.gui.MainMenu;
import cn.noblefull.module.ClientApplication;
import cn.noblefull.module.impl.combat.TickBase;
import cn.noblefull.module.impl.visuals.Animations;
import cn.noblefull.module.impl.world.Disabler;
import cn.jnic.JNICInclude;
import cn.noblefull.utils.animations.AnimationUtils;
import cn.noblefull.utils.player.MovementInputKeyboard;
...
public class Minecraft {
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        gameThread.setName("Client-Client");
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            ...
            RenderUtil.drawImage(new ResourceLocation("noblefull/background.jpg"),0,0,sr.getScaledWidth(),sr.getScaledHeight());
