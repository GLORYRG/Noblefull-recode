...
public class GuiButton extends Gui {
    ...
    public void drawButton(Mine mc, int mouseX, int mouseY) {
        ...
        if (this.visible) {
            ...
            RoundedUtil.drawRound(this.xPosition, this.yPosition, this.width, this.height, 5,new Color(0,0,0,120));
            ...
            drawCenteredString(fontrenderer, this.displayString, (int) (this.xPosition + this.width / 2), (int) (this.yPosition + (this.height - 8) / 2), j);
        }
    }
