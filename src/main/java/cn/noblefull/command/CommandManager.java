...
import cn.noblefull.utils.chats.ChatUtils;
...
public class CommandManager {
    ...
    private boolean handleConfigCommand(String[] args) {
        ...
        switch (subCommand) {
            ...
            case "list":
                ...
                if (configs.isEmpty()) {
                    ChatUtils.sendMessage(EnumChatFormatting.YELLOW + "[Noblefull] No configs found.");
                } else {
                    ChatUtils.sendMessage(EnumChatFormatting.GOLD + "[Noblefull] Available configs:");
    ...
    private boolean handleHelpCommand() {
        ChatUtils.sendMessage(EnumChatFormatting.GOLD + "[Noblefull] Available commands:");
    ...
    private boolean handleBindsCommand() {
        ChatUtils.sendMessage(EnumChatFormatting.GOLD + "[Noblefull] Current keybinds:");
