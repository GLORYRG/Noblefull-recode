...
import cn.noblefull.utils.animations.impl.EaseBackIn;
...
public class EffectHUD extends ModuleWidget {
    public ModeValue modeValue = new ModeValue("Mode", "Custom",new String[]{"Normal","Custom","Noblefull"});
        ...
        switch (modeValue.getValue()) {
            ...
            case "Custom":
                ...
                for (PotionEffect potioneffect : effects) {
                    RenderUtil.drawRoundedRect(x + 15, y + i2 - 18, 120, 32, InterFace.radius.get().intValue(), new Color(1, 1, 1, 255).getRGB());
                    i2 += l;
                }
                setWidth(100);
                setHeight(22 + i2);
    ...
    public void render() {
        ...
        switch (modeValue.getValue()) {
            ...
            case "Custom":
                ...
                for (PotionEffect potioneffect : effects) {
                    RenderUtil.drawRoundedRect(x + 15, y + i2 - 18, 120, 32, InterFace.radius.get().intValue() ,new Color(1, 1, 1, 60).getRGB());
                    RenderUtil.drawRoundedRect(x + 15, (y + i2) - 18, (float) ((potioneffect.getDuration() / (1.0f * this.potionMaxDurations.get(potioneffect.getPotionID()))) * 120), 32,InterFace.radius.get().intValue(), new Color(1, 1, 1, 50).getRGB());
                    Potion potion = Potion.potionTypes[potioneffect.getPotionID()];
                    String s1 = get(potioneffect);
                    if (potion.hasStatusIcon()) {
                        GL11.glPushMatrix();
                    ...
                    FontManager.Semibold.get(18).drawString(s1, x + offsetX + 22, (y + i2) - offsetY + 10, -1);
            ...
            case "Normal":
                ...
                RoundedUtil.drawRound(x, y, 120, 30, InterFace.radius.get().intValue(), ColorUtil.applyOpacity(new Color(INTERFACE.color(1).getRGB()), (float) 0.3f));
