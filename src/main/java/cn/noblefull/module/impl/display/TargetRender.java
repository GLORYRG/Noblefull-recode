...
import cn.noblefull.utils.render.ParticleRenderer;
...
public class TargetRender extends ModuleWidget {
    ...
    public int bgColor(int counter, int alpha) {
        int colors = setting.color();
        colors = switch (bgColor.get()) {
            case "Dark" -> (new Color(21, 21, 21, alpha)).getRGB();
            case "Synced" ->
                    new Color(ColorUtil.applyOpacity(setting.color(), alpha / 255f), true).darker().darker().getRGB();
        ...
        switch (style.get()) {
            case "Astolfo": {
                if (!shader) {
                    ...
                    mc.fontRendererObj.drawStringWithShadow(String.format("%.1f", target.getHealth()) + " ❤", (x + 50) / 1.5f, (y + 22) / 1.5f, setting.color());
                    ...
                    RoundedUtil.drawRound(x + 48, y + 42, width - 54, 7, 0, ColorUtil.applyOpacity(new Color(setting.color()).darker().darker().darker(), (float) (1 * animation.getOutput())));
                    RoundedUtil.drawRound(x + 48, y + 42, target.healthAnimation.getOutput(), 7, 0, ColorUtil.applyOpacity(new Color(setting.color()), (float) (1 * animation.getOutput())));
                } else {
            ...
            case "Type 1": {
                ...
                if (!shader) {
                    ...
                    RoundedUtil.drawGradientHorizontal(x + 44, y + 30, target.healthAnimation.getOutput(), 6, 3, ColorUtil.applyOpacity(new Color(setting.color()), (float) animation.getOutput().intValue()), ColorUtil.applyOpacity(new Color(setting.color()), (float) animation.getOutput().intValue()));
                } else {
            ...
            case "Type 2": {
                if (!shader) {
                    ...
                    RoundedUtil.drawGradientHorizontal(x + 5 * 3 + 26.5f, y + 26.5f, target.healthAnimation.getOutput(), 3.8f, 2, new Color(setting.color()), new Color(setting.color()));
                    ...
                    RoundedUtil.drawGradientHorizontal(x, y, width, height, 4, new Color(setting.color()), new Color(setting.color()));
                }
            ...
            case "Moon": {
                ...
                if (!shader) {
                    ...
                    RoundedUtil.drawRound(x + 42, y + 26.5f, target.healthAnimation.getOutput(), 8.5f, 4, new Color(setting.color()));
            ...
            case "New": {
                ...
                if (!shader) {
                    ...
                    RoundedUtil.drawRound(x + 42, y + 22f, target.healthAnimation.getOutput(), 6f, 3, new Color(setting.color()));
                    RoundedUtil.drawRoundOutline(x, y, this.width, this.height, 5, 0.1f, new Color(0, 0, 0, 0), new Color(setting.color()));
            ...
            case "Novo 2": {
                ...
                if (!shader) {
                    ...
                    String text = String.format("%.1f", target.getHealth());
                    mc.fontRendererObj.drawStringWithShadow("❤", x + 62 + 1, y + 26.6f, setting.color());
            ...
            case "Novo 5": {
                ...
                if (!shader) {
                    ...
                    RenderUtil.drawGradientRect(x + 3.2f, y + 39, target.healthAnimation.getOutput(), 4, true, setting.color(), setting.color());
            ...
            case "Innominate": {
                ...
                if (!shader) {
                    ...
                    RenderUtil.drawBorderedRect(x + 2,y + 2 + Regular.get(16).getHeight() + 16,target.healthAnimation.getOutput(),5,1,setting.color(),Color.DARK_GRAY.getRGB());
                } else {
                    RenderUtil.drawBorderedRect(x, y, width, height,1, Color.BLACK.getRGB(),Color.DARK_GRAY.getRGB());
                }
            }
