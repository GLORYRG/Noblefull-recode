...
import cn.noblefull.module.impl.combat.KillAura;
...
import cn.noblefull.utils.render.shader.impl.Bloom;
...
public class InterFace extends Module {
    ...
    public static ModeValue waterMarkmode = new ModeValue("WaterMarkMode",()-> waterMark.get(),"Exhi",new String[]{"Exhi","Noblefull","Exhibition","Sigma"});
    public static BoolValue info = new BoolValue("Info",true);
    public static final ModeValue infomode = new ModeValue("InfoMode",()->info.get(),"Exhi",new String[]{"Exhi","Noblefull"});
    ...
    public static final BoolValue clickguimoduleShadow = new BoolValue("ClickGui Module Shadow", false);
    public static final BoolValue clickguimoduleBlur = new BoolValue("ClickGui Module Blur", false);
