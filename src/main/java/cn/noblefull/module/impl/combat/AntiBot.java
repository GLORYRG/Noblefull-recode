...
public class AntiBot extends Module {
    ...
    static ModeValue mode = new ModeValue("Mode","Hypixel",new String[]{"Hypixel","Mineland","Matrix"});
    ...
    public static boolean isBot(Entity entity) {
        ...
        if(Client.Instance.getModuleManager().getModule(AntiBot.class).getState() && mode.getValue().equals("Matrix")){
...
//                    Notifications.getManager( ).post( "AntiBot", "Staff might be checking you!(detected sus bot)" );
    ...
    public static void tellPlayer(String message) {
        Mine.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText("\247a[Noblefull] \247r" + message));
    }
