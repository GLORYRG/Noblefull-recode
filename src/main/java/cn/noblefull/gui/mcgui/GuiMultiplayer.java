package cn.noblefull.gui.mcgui;
...
import cn.noblefull.utils.render.shader.MainMenu;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    private final GuiButton back = new GuiButton(I18n.format("gui.cancel"), () -> mc.displayGuiScreen(new cn.noblefull.gui.MainMenu()), new Color(0, 0, 0, 120), new Color(127, 127, 213));
