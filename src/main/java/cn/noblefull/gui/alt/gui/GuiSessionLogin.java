package cn.noblefull.gui.alt.gui;
...
import cn.noblefull.gui.alt.elixir.account.MicrosoftAccount;
        ...
        if (button != null && button.id == 1) {
            ...
            try {
                ...
                if (token.startsWith("M.C")) {
                    ...
                    cn.noblefull.gui.alt.elixir.compat.Session customSession = microsoftAccount.getSession();
