...
import cn.noblefull.gui.alt.auth.Account;
import cn.noblefull.gui.alt.auth.MicrosoftAuth;
import cn.noblefull.gui.alt.auth.SessionManager;
import cn.noblefull.gui.alt.gui.GuiAltCracked;
import cn.noblefull.gui.alt.gui.GuiMicrosoftAuth;
import cn.noblefull.gui.alt.gui.GuiSessionLogin;
import cn.noblefull.gui.alt.utils.Notification;
...
public class GuiAccountManager extends GuiScreen {
  ...
  public void drawScreen(int mouseX, int mouseY, float renderPartialTicks) {
    ...
    cn.noblefull.utils.render.shader.MainMenu.drawBackground(sr.getScaledWidth(), sr.getScaledHeight(), mouseX, mouseY);
