package cn.noblefull.utils.animations;

import cn.noblefull.utils.animations.impl.Type;
import cn.noblefull.utils.render.RenderUtil;

import java.awt.*;

public class ColorAnimation {
    private final cn.noblefull.utils.animations.impl.Animation r = new cn.noblefull.utils.animations.impl.Animation();
    private final cn.noblefull.utils.animations.impl.Animation g = new cn.noblefull.utils.animations.impl.Animation();
    private final cn.noblefull.utils.animations.impl.Animation b = new cn.noblefull.utils.animations.impl.Animation();
    private final cn.noblefull.utils.animations.impl.Animation a = new cn.noblefull.utils.animations.impl.Animation();
