...
public class GLSLSandboxShader {
    ...
    public GLSLSandboxShader(String fragmentShaderLocation) throws Exception {
        ...
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/noblefull/shaders/passthrough.glsl"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(GLSLSandboxShader.class.getResourceAsStream("/assets/minecraft/noblefull/shaders/" + fragmentShaderLocation), GL_FRAGMENT_SHADER));
