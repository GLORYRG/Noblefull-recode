...
import cn.noblefull.utils.file.FileUtils;
...
public class ShaderUtils implements Instance {
    ...
    public ShaderUtils(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("noblefull/shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtils(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "noblefull/shaders/vertex.vsh");
    }
